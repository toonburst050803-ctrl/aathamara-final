...
const packages = [
  ...
  },
  {
    ...
    includedServices: ['Advanced Meta Ads', 'Retargeting Campaigns', 'Instagram Growth', 'Creative Strategy', 'Conversion Optimization', 'Multiple Ad Testing', 'Audience Scaling', 'Professional Reels Support'],
  ...
  },
  {
    ...
    includedServices: ['Full Funnel Meta Strategy', 'Premium Branding', 'Viral Reel Marketing', 'Luxury Video Production', 'Dedicated Campaign Management', 'Audience Scaling', 'Multi Audience Testing', 'Conversion Retargeting', 'Booking Optimization'],
